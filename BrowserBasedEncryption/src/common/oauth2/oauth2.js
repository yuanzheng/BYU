...
OAuth2.prototype.openAuthorizationCodePopup = function(callback) {
  ...
  window.open(this.adapter.authorizationCodeURL(this.getConfig()), "LoginWindow", "toolbar=yes, scrollbars=yes, resizable=yes, width=600, height=700,left=190, top=88");
